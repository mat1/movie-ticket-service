...
var _user$project$Main$movieDecoder = A3(
	...
	A3(
		...
		A3(
			...
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Movie))));
var _user$project$Main$MovieDetail = F4(
	function (a, b, c, d) {
		return {id: a, title: b, plot: c, genre: d};
	});
var _user$project$Main$movieDetailDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'genre',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				_elm_lang$core$Json_Decode$int,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$MovieDetail)))));
var _user$project$Main$LoadMovie = function (a) {
	return {ctor: 'LoadMovie', _0: a};
};
var _user$project$Main$loadMovie = function (id) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$LoadMovie,
		A2(
			...
			_user$project$Main$movieDetailDecoder));
};
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$FilterMovies),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$LoadMovies = function (a) {
	return {ctor: 'LoadMovies', _0: a};
};
var _user$project$Main$initialCmd = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$LoadMovies,
	A2(
		_elm_lang$http$Http$get,
		'http://localhost:8080/api/v1/movies',
...
var _user$project$Main$init = {
	...
	_1: _user$project$Main$initialCmd
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$init, view: _user$project$Main$viewOrError, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})();
var _user$project$Main$ShowDetails = {ctor: 'ShowDetails'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Main.MovieDetail":{"type":"{ id : Int, title : String, plot : String, genre : String }","args":[]},"Main.Movie":{"type":"{ id : Int, poster : String, title : String }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Main.Msg":{"tags":{"LoadMovies":["Result.Result Http.Error (List Main.Movie)"],"FilterMovies":["String"],"LoadMovie":["Result.Result Http.Error Main.MovieDetail"],"ShowDetails":[],"SelectMovie":["Int"]},"args":[]},"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
